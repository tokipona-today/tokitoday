...
./plugin/ftdetect/tokipona.vim	[[[1
1
autocmd BufNewFile,BufRead *.tokipona,*.tp setfiletype tokipona
./plugin/ftplugin/tokipona/folding.vim	[[[1
9
...
./plugin/ftplugin/tokipona/basic.vim	[[[1
1
set tabstop=2 softtabstop=2 shiftwidth=2 textwidth=70 expandtab autoindent
